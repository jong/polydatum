...
from polydatum.dal import PathSegment, DataManager
...
class UserService(Service):
    def user_test_method(self):
        return 'user-service'


class UserProfileService(Service):
    def profile_test_method(self):
...
class ExampleService(Service):
    def example_test_method(self):
        return 'example-nested-service'


class DemoService(Service):
    def demo_test_method(self):
